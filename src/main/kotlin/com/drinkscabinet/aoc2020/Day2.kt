...
fun main() {
    ...
    val valid1 = input.lines().map { Rule.parse(it) }.filter { it.valid() }.count()
    val valid2 = input.lines().map { Rule.parse(it) }.filter { it.valid2() }.count()

    println("Part1=$valid1 Part2=$valid2")
}
