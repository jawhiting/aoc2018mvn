            ...
            grid.lines().forEachIndexed { y, s ->
                s.forEachIndexed { x, c ->
                    run {
                        ...
                        when (c) {
                            'E', 'G' -> {
                                entities[coord] = Entity(
                                    Race.valueOf("" + c), coord
                                )
                                nodes[coord] =
...
fun main() {
//    com.drinkscabinet.aoc2018.testRun()
    part2()
}
...
private fun testMovement() {
    val b =
        Battle.parse(test1)
    println(b)
    //    com.drinkscabinet.aoc2018.dijkstra(com.drinkscabinet.Coord(1,1), b.nodes)
    val routes = dijkstra(
        Coord(3, 2),
        b.nodes
    )
