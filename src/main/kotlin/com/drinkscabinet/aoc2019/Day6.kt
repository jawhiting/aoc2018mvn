...
private fun main() {
    ...
    println(pathToYou)
    val pathToSan = path(map, "COM", "SAN")
    println(pathToSan)
    // find common ancestor
    pathToSan.toSet()
    val commonAncestor = pathToYou.first { pathToSan.contains(it) }
    println(commonAncestor)
    println("Transfers = " + (pathToYou.indexOf(commonAncestor) + pathToSan.indexOf(commonAncestor)))
